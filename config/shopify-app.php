...
$baseUrl = env('APP_WEBHOOK_URL') ?: env('APP_URL');
...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,write_themes,read_pixels,write_pixels,read_customer_events'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Whether to enable expiring offline tokens.
    | 
    */
    'expiring_offline_tokens' => (bool) env('SHOPIFY_EXPIRING_OFFLINE_TOKENS', false),
    'offline_access_token_refresh_skew_seconds' => (int) env('SHOPIFY_OFFLINE_ACCESS_TOKEN_REFRESH_SKEW', 300),
