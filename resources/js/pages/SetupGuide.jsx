...
export default function SetupGuide() {
  const steps = [
    ...
    {
      id: 4,
      title: "4. Optional: connect your Advertiser key",
      content: (
        <span>
          A second key from Ads Manager unlocks spend, ROAS, and CPA on your{" "}
          <RouterLink
            to="/"
            style={{
              color: "#616161",
          ...
          page, so you see what you spent next to what it earned. You can add it
          anytime in{" "}
          <RouterLink
            to="/settings"
            style={{
    ...
    {
      id: 5,
      title: "5. What Free includes, and what Basic adds",
      content: (
        <span>
